...
$params = parseVitrual($appKey,$appSecret,$req_array);
$status = 'success';//状态根据自己逻辑返回
$credits = '10000';//此处填写用户剩余积分
$errorMessage='';
$supplierBizId='31213123';//此处开发者自己创建订单号，不要重复响应
$result = array ('credits'=>$credits,'status'=>$status,'supplierBizId'=>$supplierBizId,'errorMessage'=>$errorMessage);
